...
function start() {
  document.getElementById('title').innerText='Valentine vui vẻ nha, ngày càng thêm xinh'
  ...
  var x = setInterval(function () {
    ...
    if (distance <= 0) {
      clearInterval(x);
      document.getElementById("container").innerHTML = "<h1>VALENTINE <br> <span>Hồ Thị Huỳnh Nhi</span> </h1>";
